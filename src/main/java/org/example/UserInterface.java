...
public class UserInterface {
    public void startProgram() {
        ...
        do {
            ...
            if (userChoice == VIEW) {
                ArrayList<Superhero> loadedSuperheroes = control.getSuperheroes();
                System.out.println("Loaded Superheroes:");
                for (Superhero superhero : loadedSuperheroes) {
            ...
            if (userChoice == EDIT) {
               ...
               control.editSuperheroes(heroNumberPicked, newHero);
